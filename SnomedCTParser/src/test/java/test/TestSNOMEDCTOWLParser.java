...
//	public static final String snomedOWLFileName = "/res_StatedOWLF_Core_INT_20140131.owl";
	...
	public void testParseAndSaveOWLOntology()
			throws OWLOntologyCreationException, OWLOntologyStorageException, MalformedURLException {
	//	URL expressionsURL = getClass().getResource("/example_expression.sct");
		URL expressionsURL = new URL("file://home/medhanie/Documents/2nd_year_courses/My_thesis_work/Source_Code/SnomedCTParser/src/test/resources/example_expression.sct");
