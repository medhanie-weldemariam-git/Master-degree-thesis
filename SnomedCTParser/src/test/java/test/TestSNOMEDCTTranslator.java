...
//		SNOMEDCTTranslator.main(new String[] {"-l", "-f", "owlf", "-n", "stated", "/home/danka74/Documents/Projekt/Snomed/ordorsak/ordorsak.sct"});
	...
	public void testMain2() throws OWLException, IOException {
		...
		SNOMEDCTTranslator.main(new String[] {"-l", "-f", "owlf", "-n", "flat", "/home/medhanie/Documents/2nd_year_courses/My_thesis_work/Source_Code/SnomedCTParser/target/test-classes/obsTechPreviewExtract.owl"});
	}
	*/
}
