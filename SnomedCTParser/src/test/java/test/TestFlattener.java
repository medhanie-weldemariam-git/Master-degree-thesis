...
public class TestFlattener {
	...
	@Test
	public void test() throws OWLOntologyCreationException, OWLOntologyStorageException, MalformedURLException {
		OWLOntologyManager manager = OWLManager.createOWLOntologyManager();
		//URL expressionsURL = getClass().getResource("/obsTechPreviewExtract.owl");
		URL expressionsURL =  new URL("file:///home/medhanie/Documents/2nd_year_courses/My_thesis_work/Source_Code/SnomedCTParser/target/test-classes/obsTechPreviewExtract.owl");
